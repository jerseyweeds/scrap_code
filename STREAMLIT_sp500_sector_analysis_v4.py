...
if select_all_sectors:
    selected_sectors = list(df['Sector'].unique())
else:
    selected_sectors = st.sidebar.multiselect('Select Sectors', list(df['Sector'].unique()), default=list(df['Sector'].unique()))
...
if generate_charts:
    # Your chart plotting code here (deferred until the button is pressed)
    pass
